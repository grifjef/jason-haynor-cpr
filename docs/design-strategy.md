...
- **Visual direction:** Firefighter **red (#C8102E)** + **charcoal ink (#16181D)** + **warm off-white (#FBF6F1)**, deep maroon for depth, one warm amber highlight sparingly. Custom **inline-SVG Maltese-cross + heartbeat logo** (self-contained, crisp, high-contrast — a modernized nod to the current emblem). Authentic class photography (AI placeholders now, real class photos at launch). Heartbeat/pulse line as a recurring motif.
